...
`,styles:(e,t)=>Mt`
	...
	${Es}
	${Ds}
`,shadowOptions:{delegatesFocus:!0}});class Fs extends Ee{}class Ls extends(vs(Fs)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Ms extends Ls{constructor(){super(),this.initialValue="on",this.indeterminate=!1,this.keypressHandler=e=>{this.readOnly||e.key!==ds||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.clickHandler=e=>{this.disabled||this.readOnly||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}}H([B({attribute:"readonly",mode:"boolean"})],Ms.prototype,"readOnly",void 0),H([m],Ms.prototype,"defaultSlottedNodes",void 0),H([m],Ms.prototype,"indeterminate",void 0);class Vs extends Ms{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Hs=Vs.compose({baseName:"checkbox",template:(e,t)=>Ft`
    <template
        role="checkbox"
...
`;class bo extends Ee{constructor(){super(...arguments),this.cellType=js.default,this.rowData=null,this.columnDefinition=null,this.isActiveCell=!1,this.customCellView=null,this.updateCellStyle=()=>{this.style.gridColumn=this.gridColumn}}cellTypeChanged(){this.$fastController.isConnected&&this.updateCellView()}gridColumnChanged(){this.$fastController.isConnected&&this.updateCellStyle()}columnDefinitionChanged(e,t){this.$fastController.isConnected&&this.updateCellView()}connectedCallback(){var e;super.connectedCallback(),this.addEventListener(no,this.handleFocusin),this.addEventListener(ro,this.handleFocusout),this.addEventListener(ao,this.handleKeydown),this.style.gridColumn=`${void 0===(null===(e=this.columnDefinition)||void 0===e?void 0:e.gridColumn)?0:this.columnDefinition.gridColumn}`,this.updateCellView(),this.updateCellStyle()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(no,this.handleFocusin),this.removeEventListener(ro,this.handleFocusout),this.removeEventListener(ao,this.handleKeydown),this.disconnectCellView()}handleFocusin(e){if(!this.isActiveCell){if(this.isActiveCell=!0,this.cellType===js.columnHeader){if(null!==this.columnDefinition&&!0!==this.columnDefinition.headerCellInternalFocusQueue&&"function"==typeof this.columnDefinition.headerCellFocusTargetCallback){const e=this.columnDefinition.headerCellFocusTargetCallback(this);null!==e&&e.focus()}}else if(null!==this.columnDefinition&&!0!==this.columnDefinition.cellInternalFocusQueue&&"function"==typeof this.columnDefinition.cellFocusTargetCallback){const e=this.columnDefinition.cellFocusTargetCallback(this);null!==e&&e.focus()}this.$emit("cell-focused",this)}}handleFocusout(e){this===document.activeElement||this.contains(document.activeElement)||(this.isActiveCell=!1)}handleKeydown(e){if(!(e.defaultPrevented||null===this.columnDefinition||this.cellType===js.default&&!0!==this.columnDefinition.cellInternalFocusQueue||this.cellType===js.columnHeader&&!0!==this.columnDefinition.headerCellInternalFocusQueue))switch(e.key){case ns:case"F2":if(this.contains(document.activeElement)&&document.activeElement!==this)return;if(this.cellType===js.columnHeader){if(void 0!==this.columnDefinition.headerCellFocusTargetCallback){const t=this.columnDefinition.headerCellFocusTargetCallback(this);null!==t&&t.focus(),e.preventDefault()}}else if(void 0!==this.columnDefinition.cellFocusTargetCallback){const t=this.columnDefinition.cellFocusTargetCallback(this);null!==t&&t.focus(),e.preventDefault()}break;case rs:this.contains(document.activeElement)&&document.activeElement!==this&&(this.focus(),e.preventDefault())}}updateCellView(){if(this.disconnectCellView(),null!==this.columnDefinition)switch(this.cellType){case js.columnHeader:void 0!==this.columnDefinition.headerCellTemplate?this.customCellView=this.columnDefinition.headerCellTemplate.render(this,this):this.customCellView=fo.render(this,this);break;case void 0:case js.rowHeader:case js.default:void 0!==this.columnDefinition.cellTemplate?this.customCellView=this.columnDefinition.cellTemplate.render(this,this):this.customCellView=po.render(this,this)}}disconnectCellView(){null!==this.customCellView&&(this.customCellView.dispose(),this.customCellView=null)}}H([B({attribute:"cell-type"})],bo.prototype,"cellType",void 0),H([B({attribute:"grid-column"})],bo.prototype,"gridColumn",void 0),H([m],bo.prototype,"rowData",void 0),H([m],bo.prototype,"columnDefinition",void 0);class go extends lo{connectedCallback(){super.connectedCallback(),this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const vo=go.compose({baseName:"data-grid",baseClass:lo,template:(e,t)=>{const i=function(e){const t=e.tagFor(uo);return Ft`
    <${t}
        :rowData="${e=>e}"
...
`}),wo={separator:"separator",presentation:"presentation"},$o={horizontal:"horizontal",vertical:"vertical"};class ko extends Ee{constructor(){super(...arguments),this.role=wo.separator,this.orientation=$o.horizontal}}H([B],ko.prototype,"role",void 0),H([B],ko.prototype,"orientation",void 0);class Io extends ko{}const Oo=Io.compose({baseName:"divider",template:(e,t)=>Ft`
...
`,checkedIndicator:'\n\t\t<div part="checked-indicator" class="checked-indicator"></div>\n\t'});class wn extends lt{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const $n=wn.compose({baseName:"tag",template:Lt,styles:(e,t)=>Mt`
	${Vt("inline-block")} :host {
		box-sizing: border-box;
		font-family: ${Yt};
		font-size: ${si};
...
`}),kn={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class In extends Ee{}class On extends(gs(In)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const Tn={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Sn extends On{constructor(){super(...arguments),this.type=Tn.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}H([B({attribute:"readonly",mode:"boolean"})],Sn.prototype,"readOnly",void 0),H([B({mode:"boolean"})],Sn.prototype,"autofocus",void 0),H([B],Sn.prototype,"placeholder",void 0),H([B],Sn.prototype,"type",void 0),H([B],Sn.prototype,"list",void 0),H([B({converter:D})],Sn.prototype,"maxlength",void 0),H([B({converter:D})],Sn.prototype,"minlength",void 0),H([B],Sn.prototype,"pattern",void 0),H([B({converter:D})],Sn.prototype,"size",void 0),H([B({mode:"boolean"})],Sn.prototype,"spellcheck",void 0),H([m],Sn.prototype,"defaultSlottedNodes",void 0);class An{}Zi(An,Ki),Zi(Sn,Xi,An);class Rn extends Ee{}class En extends(gs(Rn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class Dn extends En{constructor(){super(...arguments),this.resize=kn.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}H([B({mode:"boolean"})],Dn.prototype,"readOnly",void 0),H([B],Dn.prototype,"resize",void 0),H([B({mode:"boolean"})],Dn.prototype,"autofocus",void 0),H([B({attribute:"form"})],Dn.prototype,"formId",void 0),H([B],Dn.prototype,"list",void 0),H([B({converter:D})],Dn.prototype,"maxlength",void 0),H([B({converter:D})],Dn.prototype,"minlength",void 0),H([B],Dn.prototype,"name",void 0),H([B],Dn.prototype,"placeholder",void 0),H([B({converter:D,mode:"fromView"})],Dn.prototype,"cols",void 0),H([B({converter:D,mode:"fromView"})],Dn.prototype,"rows",void 0),H([B({mode:"boolean"})],Dn.prototype,"spellcheck",void 0),H([m],Dn.prototype,"defaultSlottedNodes",void 0),Zi(Dn,An);class Pn extends Dn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Bn=Pn.compose({baseName:"text-area",template:(e,t)=>Ft`
    <template
        class="
