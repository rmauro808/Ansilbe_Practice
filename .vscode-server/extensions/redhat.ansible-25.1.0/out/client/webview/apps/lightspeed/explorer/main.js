...
`}),$o={separator:"separator",presentation:"presentation"},wo={horizontal:"horizontal",vertical:"vertical"};class ko extends De{constructor(){super(...arguments),this.role=$o.separator,this.orientation=wo.horizontal}}M([B],ko.prototype,"role",void 0),M([B],ko.prototype,"orientation",void 0);class Io extends ko{}const To=Io.compose({baseName:"divider",template:(e,t)=>Ft`
...
`}),kn={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class In extends De{}class Tn extends(gs(In)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const On={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Sn extends Tn{constructor(){super(...arguments),this.type=On.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([B({attribute:"readonly",mode:"boolean"})],Sn.prototype,"readOnly",void 0),M([B({mode:"boolean"})],Sn.prototype,"autofocus",void 0),M([B],Sn.prototype,"placeholder",void 0),M([B],Sn.prototype,"type",void 0),M([B],Sn.prototype,"list",void 0),M([B({converter:E})],Sn.prototype,"maxlength",void 0),M([B({converter:E})],Sn.prototype,"minlength",void 0),M([B],Sn.prototype,"pattern",void 0),M([B({converter:E})],Sn.prototype,"size",void 0),M([B({mode:"boolean"})],Sn.prototype,"spellcheck",void 0),M([m],Sn.prototype,"defaultSlottedNodes",void 0);class An{}Zi(An,Ki),Zi(Sn,Xi,An);class Rn extends De{}class Dn extends(gs(Rn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class En extends Dn{constructor(){super(...arguments),this.resize=kn.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([B({mode:"boolean"})],En.prototype,"readOnly",void 0),M([B],En.prototype,"resize",void 0),M([B({mode:"boolean"})],En.prototype,"autofocus",void 0),M([B({attribute:"form"})],En.prototype,"formId",void 0),M([B],En.prototype,"list",void 0),M([B({converter:E})],En.prototype,"maxlength",void 0),M([B({converter:E})],En.prototype,"minlength",void 0),M([B],En.prototype,"name",void 0),M([B],En.prototype,"placeholder",void 0),M([B({converter:E,mode:"fromView"})],En.prototype,"cols",void 0),M([B({converter:E,mode:"fromView"})],En.prototype,"rows",void 0),M([B({mode:"boolean"})],En.prototype,"spellcheck",void 0),M([m],En.prototype,"defaultSlottedNodes",void 0),Zi(En,An);class Pn extends En{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Bn=Pn.compose({baseName:"text-area",template:(e,t)=>Ft`
    <template
        class="
