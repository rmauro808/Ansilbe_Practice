...
`,shadowOptions:{delegatesFocus:!0}}),Vn={vsCodeBadge:Gi,vsCodeButton:Ps,vsCodeCheckbox:Ms,vsCodeDataGrid:vo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:To,vsCodeDropdown:Go,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Pn,vsCodeTextField:Hn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p,f,b,g,v;window.addEventListener("load",(function(){n=document.getElementById("plugin-name"),r=document.getElementById("plugin-dropdown"),a=document.getElementById("path-url"),l=document.getElementById("folder-explorer"),h=document.getElementById("overwrite-checkbox"),u=document.getElementById("verbosity-dropdown"),d=document.getElementById("create-button"),c=document.getElementById("clear-button"),b=document.getElementById("log-text-area"),g=document.getElementById("clear-logs-button"),v=document.getElementById("open-folder-button"),n.addEventListener("input",C),a.addEventListener("input",C),l.addEventListener("click",y),d.addEventListener("click",$),d.disabled=!0,c.addEventListener("click",x),g.addEventListener("click",w),v.addEventListener("click",k),p=document.getElementById("full-collection-path"),f=document.createElement("p"),f.innerHTML=a.placeholder,p?.appendChild(f)}));let m="";function y(e){const t=e.target.parentNode.id;let i;i="folder-explorer"===t?"folder":"file",o.postMessage({command:"open-explorer",payload:{selectOption:i}}),window.addEventListener("message",(e=>{const i=e.data;if("file-uri"===i.command){const e=i.arguments.selectedUri;e&&"folder-explorer"===t&&(a.value=e,f.innerHTML=e)}}))}function x(){n.value="",r.currentValue="filter",a.value="",f.innerHTML=a.placeholder,h.checked=!1,u.currentValue="Off",d.disabled=!0}function C(){a.value.trim()?f.innerHTML=a.value.trim():(f.innerHTML=`${a.placeholder}/plugins/${r.currentValue.trim()}/${n.value.trim()}`,n.value.trim()||(f.innerHTML=a.placeholder)),n.value.trim()?d.disabled=!1:d.disabled=!0}function $(){d.disabled=!0,o.postMessage({command:"init-create",payload:{pluginName:n.value.trim(),pluginType:r.currentValue.trim(),collectionPath:a.value.trim(),verbosity:u.currentValue.trim(),isOverwritten:h.checked}}),window.addEventListener("message",(async e=>{const t=e.data;if("execution-log"===t.command)return b.value=t.arguments.commandOutput,t.arguments.status&&"passed"===t.arguments.status?v.disabled=!1:v.disabled=!0,m=t.arguments.projectUrl?t.arguments.projectUrl:"",void(d.disabled=!1)}))}function w(){b.value=""}function k(){o.postMessage({command:"init-open-scaffolded-folder",payload:{projectUrl:m}})}})();var o=s.B;export{o as __esModule};
