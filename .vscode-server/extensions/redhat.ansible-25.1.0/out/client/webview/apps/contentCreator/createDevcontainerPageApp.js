...
`,styles:(e,t)=>Ht`
	...
	${Es}
	${Ds}
`,shadowOptions:{delegatesFocus:!0}});class Fs extends Ee{}class Ls extends(vs(Fs)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Hs extends Ls{constructor(){super(),this.initialValue="on",this.indeterminate=!1,this.keypressHandler=e=>{this.readOnly||e.key!==ds||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.clickHandler=e=>{this.disabled||this.readOnly||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}}M([P({attribute:"readonly",mode:"boolean"})],Hs.prototype,"readOnly",void 0),M([m],Hs.prototype,"defaultSlottedNodes",void 0),M([m],Hs.prototype,"indeterminate",void 0);class Vs extends Hs{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Ms=Vs.compose({baseName:"checkbox",template:(e,t)=>Ft`
    <template
        role="checkbox"
...
`}),$o={separator:"separator",presentation:"presentation"},wo={horizontal:"horizontal",vertical:"vertical"};class ko extends Ee{constructor(){super(...arguments),this.role=$o.separator,this.orientation=wo.horizontal}}M([P],ko.prototype,"role",void 0),M([P],ko.prototype,"orientation",void 0);class Io extends ko{}const To=Io.compose({baseName:"divider",template:(e,t)=>Ft`
...
`,indicator:'\n\t\t<svg \n\t\t\tclass="select-indicator"\n\t\t\tpart="select-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M7.976 10.072l4.357-4.357.62.618L8.284 11h-.618L3 6.333l.619-.618 4.357 4.357z"\n\t\t\t/>\n\t\t</svg>\n\t'});class Ko extends Ee{constructor(){super(...arguments),this.handleUnsupportedDelegatesFocus=()=>{var e;window.ShadowRoot&&!window.ShadowRoot.prototype.hasOwnProperty("delegatesFocus")&&(null===(e=this.$fastController.definition.shadowOptions)||void 0===e?void 0:e.delegatesFocus)&&(this.focus=()=>{var e;null===(e=this.control)||void 0===e||e.focus()})}}connectedCallback(){super.connectedCallback(),this.handleUnsupportedDelegatesFocus()}}M([P],Ko.prototype,"download",void 0),M([P],Ko.prototype,"href",void 0),M([P],Ko.prototype,"hreflang",void 0),M([P],Ko.prototype,"ping",void 0),M([P],Ko.prototype,"referrerpolicy",void 0),M([P],Ko.prototype,"rel",void 0),M([P],Ko.prototype,"target",void 0),M([P],Ko.prototype,"type",void 0),M([m],Ko.prototype,"defaultSlottedContent",void 0);class Wo{}M([P({attribute:"aria-expanded"})],Wo.prototype,"ariaExpanded",void 0),Zi(Wo,Ki),Zi(Ko,Xi,Wo);class Qo extends Ko{}const Xo=Qo.compose({baseName:"link",template:(e,t)=>Ft`
    <a
        class="control"
        part="control"
...
`}),kn={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class In extends Ee{}class Tn extends(gs(In)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const On={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Sn extends Tn{constructor(){super(...arguments),this.type=On.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({attribute:"readonly",mode:"boolean"})],Sn.prototype,"readOnly",void 0),M([P({mode:"boolean"})],Sn.prototype,"autofocus",void 0),M([P],Sn.prototype,"placeholder",void 0),M([P],Sn.prototype,"type",void 0),M([P],Sn.prototype,"list",void 0),M([P({converter:D})],Sn.prototype,"maxlength",void 0),M([P({converter:D})],Sn.prototype,"minlength",void 0),M([P],Sn.prototype,"pattern",void 0),M([P({converter:D})],Sn.prototype,"size",void 0),M([P({mode:"boolean"})],Sn.prototype,"spellcheck",void 0),M([m],Sn.prototype,"defaultSlottedNodes",void 0);class An{}Zi(An,Ki),Zi(Sn,Xi,An);class Rn extends Ee{}class En extends(gs(Rn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class Dn extends En{constructor(){super(...arguments),this.resize=kn.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({mode:"boolean"})],Dn.prototype,"readOnly",void 0),M([P],Dn.prototype,"resize",void 0),M([P({mode:"boolean"})],Dn.prototype,"autofocus",void 0),M([P({attribute:"form"})],Dn.prototype,"formId",void 0),M([P],Dn.prototype,"list",void 0),M([P({converter:D})],Dn.prototype,"maxlength",void 0),M([P({converter:D})],Dn.prototype,"minlength",void 0),M([P],Dn.prototype,"name",void 0),M([P],Dn.prototype,"placeholder",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"cols",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"rows",void 0),M([P({mode:"boolean"})],Dn.prototype,"spellcheck",void 0),M([m],Dn.prototype,"defaultSlottedNodes",void 0),Zi(Dn,An);class Bn extends Dn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Pn=Bn.compose({baseName:"text-area",template:(e,t)=>Ft`
    <template
        class="
...
`,shadowOptions:{delegatesFocus:!0}}),Vn={vsCodeBadge:Gi,vsCodeButton:Ps,vsCodeCheckbox:Ms,vsCodeDataGrid:vo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:To,vsCodeDropdown:Go,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Pn,vsCodeTextField:Hn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p,f,b;window.addEventListener("load",(function(){n=document.getElementById("path-url"),r=document.getElementById("folder-explorer"),c=document.getElementById("overwrite-checkbox"),h=document.getElementById("image-dropdown"),a=document.getElementById("create-button"),l=document.getElementById("reset-button"),f=document.getElementById("log-text-area"),d=document.getElementById("clear-logs-button"),b=document.getElementById("open-file-button"),n.addEventListener("input",m),r.addEventListener("click",v),a.addEventListener("click",x),l.addEventListener("click",y),b.addEventListener("click",C),d.addEventListener("click",$),u=document.getElementById("full-devcontainer-path"),p=document.createElement("p"),""!==n.placeholder?p.innerHTML=`${n.placeholder}/.devcontainer`:p.innerHTML="No folders are open in the workspace - Enter a destination directory.",n.value=n.placeholder,n.value.trim()?a.disabled=!1:a.disabled=!0,u?.appendChild(p)}));let g="";function v(e){const t=e.target.parentNode.id;o.postMessage({command:"open-explorer",payload:{selectOption:"folder"}}),window.addEventListener("message",(e=>{const i=e.data;if("file-uri"===i.command){const e=i.arguments.selectedUri;e&&"folder-explorer"===t&&(n.value=e,p.innerHTML=e)}}))}function m(){n.value.trim()?p.innerHTML=`${n.value.trim()}/.devcontainer`:""!==n.placeholder?p.innerHTML=`${n.placeholder}/.devcontainer`:p.innerHTML="No folders are open in the workspace - Enter a destination directory.",n.value.trim()?a.disabled=!1:a.disabled=!0}function y(){n.value=n.placeholder,""!==n.placeholder?p.innerHTML=`${n.placeholder}/.devcontainer`:p.innerHTML="No folders are open in the workspace - Enter a destination directory.",c.checked=!1,h.currentValue="Upstream (ghcr.io/ansible/community-ansible-dev-tools:latest)",n.value.trim()?a.disabled=!1:a.disabled=!0}function x(){let e;a.disabled=!0,e=""===n.value?n.placeholder:n.value.trim(),o.postMessage({command:"devcontainer-create",payload:{destinationPath:e,image:h.currentValue.trim(),isOverwritten:c.checked}}),window.addEventListener("message",(async e=>{const t=e.data;if("execution-log"===t.command)return f.value=t.arguments.commandOutput,t.arguments.status&&"passed"===t.arguments.status?b.disabled=!1:b.disabled=!0,g=t.arguments.projectUrl?t.arguments.projectUrl:"",void(a.disabled=!1)}))}function C(){o.postMessage({command:"open-devcontainer",payload:{projectUrl:g}})}function $(){f.value=""}})();var o=s.B;export{o as __esModule};
//# sourceMappingURL=createDevcontainerPageApp.js.map