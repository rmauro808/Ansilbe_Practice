...
`,shadowOptions:{delegatesFocus:!0}}),Vn={vsCodeBadge:Gi,vsCodeButton:Ps,vsCodeCheckbox:Ms,vsCodeDataGrid:vo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:To,vsCodeDropdown:Go,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Pn,vsCodeTextField:Hn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p,f,b;window.addEventListener("load",(function(){n=document.getElementById("path-url"),r=document.getElementById("folder-explorer"),d=document.getElementById("overwrite-checkbox"),c=document.getElementById("verbosity-dropdown"),a=document.getElementById("create-button"),l=document.getElementById("clear-button"),p=document.getElementById("log-text-area"),f=document.getElementById("clear-logs-button"),b=document.getElementById("open-file-button"),n.addEventListener("input",y),r.addEventListener("click",v),a.addEventListener("click",x),a.disabled=!1,l.addEventListener("click",m),f.addEventListener("click",C),b.addEventListener("click",$),h=document.getElementById("full-destination-path"),u=document.createElement("p"),u.innerHTML=n.placeholder,h?.appendChild(u)}));let g="";function v(e){const t=e.target.parentNode.id;let i;i="folder-explorer"===t?"folder":"file",o.postMessage({command:"open-explorer",payload:{selectOption:i}}),window.addEventListener("message",(e=>{const i=e.data;if("file-uri"===i.command){const e=i.arguments.selectedUri;e&&"folder-explorer"===t&&(n.value=e,u.innerHTML=e)}}))}function m(){n.value="",u.innerHTML=n.placeholder,d.checked=!1,c.currentValue="Off",a.disabled=!1,b.disabled=!0}function y(){u.innerHTML=n.value.trim(),a.disabled=!1}function x(){a.disabled=!1,o.postMessage({command:"init-create",payload:{destinationPath:n.value.trim(),verbosity:c.currentValue.trim(),isOverwritten:d.checked}}),window.addEventListener("message",(async e=>{const t=e.data;if("execution-log"===t.command)return p.value=t.arguments.commandOutput,t.arguments.status&&"passed"===t.arguments.status?b.disabled=!1:b.disabled=!0,g=t.arguments.projectUrl?t.arguments.projectUrl:"",void(a.disabled=!1)}))}function C(){p.value=""}function $(){o.postMessage({command:"init-open-scaffolded-file",payload:{projectUrl:g}})}})();var o=s.B;export{o as __esModule};
//# sourceMappingURL=createSampleExecutionEnvPageApp.js.map